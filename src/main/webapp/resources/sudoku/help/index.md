...
Если игрок угадал число - ему начисляются бонусные очки[(?)](#ask).
Если не угадает - штрафные[(?)](#ask). 

Игрок может выиграть игру, если отгадает все числа - за это он получит 
несравненно много бонусных очков[(?)](#ask).

Так же игрок может запросить новую игру командой `ACT(0)` - эта команда будет 
стоить иему штрафных очков[(?)](#ask).
